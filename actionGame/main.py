...
class App:
    ...
    def __init__(self):
        ...
        # BGMの設定と再生
        pyxel.sound(0).set(note="c1", tone="s", volume="3",
                           effect=("n" * 7 + "f"), speed=7)
    ...
    def update_player(self):
        ...
        if self.player_y > pyxel.height:
            if self.player_is_alive:
                ...
                # sound effectの設定と再生
                pyxel.sound(3).set(note="c1", tone="p", volume="6",
                                   effect=("n" * 4 + "f" * 3), speed=3)
                pyxel.play(3, 5)
    ...
    def update_floor(self, x, y, is_active):
        ...
        if is_active:
            if (
                ...
                self.player_vy = -12
                # sound effectの設定と再生
                pyxel.sound(3).set(note="c1", tone="t", volume="6",
                                   effect=("n" * 4 + "f" * 3), speed=3)
                pyxel.play(3, 3)
        else:
            y += 6
